...
In recent years, "engagement" has entered the scene as a useful predictor of employee outcomes (e.g., Hanaysha, 2016; Alarcon & Edwards, 2011; Rich et al., 2010). Despite burgeoning popularity, considerable disagreement exists among psychologists on the definition and factor structure of engagement. Perhaps the most popular model of engagement describes it as comprised of three dimensions: Vigor, or high levels of energy at work; Dedication, or feelings of involvement, pride, and meaning in one's work; and Absorption, or concentration and flow while working (Schaufeli et al., 2002).
