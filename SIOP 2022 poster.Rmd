...
Rather than reject one model in favor of the other, we sought to develop an engagement measure which simultaneously captures *both*. Using bifactor analysis,
...
330 working adults were gathered to participate via snowball sampling.
