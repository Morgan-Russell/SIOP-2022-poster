...
csl: "apa7.csl"
#poster_height: "36"
#poster_width: "48" #can also do 56 X 31.5
#body_textsize: "150px"
...
```{r img-with-knitr, echo=FALSE, out.width='50%', eval=TRUE}
...
my.plotcorr(corr.scales, col=colors[((corr.scales + 1)/2) * 100], diag='ellipse', lower.panel="number", main='Correlations among subscales')
```


# Discussion

The present research introduces a novel measure of engagement, developed in English and available for free. By designing items to correspond to two separate factor structures, we effectively double our content domain coverage with the same number of items. Most novelly, we intentionally embrace complexity in scale development. We believe this approach has promising implications for developing measures which reconcile, rather than reject, disparate models of constructs. It it our hope that future researchers will weigh the benefits of broadening item complexity against the understandable desire for parsimony.
